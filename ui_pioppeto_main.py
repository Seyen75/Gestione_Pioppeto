...
"}")
        ...
        self.gridLayoutWidget.setGeometry(QRect(20, 188, 971, 381))
        self.gridLayout = QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(20, 20, 20, 20)
        self.btn_gestione_ditta = QPushButton(self.gridLayoutWidget)
        ...
        self.btn_gestione_ditta.setIcon(icon)
        self.btn_gestione_ditta.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.btn_gestione_ditta, 0, 1, 1, 1)

        self.btn_simulazione = QPushButton(self.gridLayoutWidget)
        ...
        self.btn_simulazione.setIcon(icon1)
        self.btn_simulazione.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.btn_simulazione, 2, 0, 1, 1)

        self.btn_gestione_lotti = QPushButton(self.gridLayoutWidget)
        ...
        icon2 = QIcon(QIcon.fromTheme(u"preferences-desktop-locale"))
        self.btn_gestione_lotti.setIcon(icon2)
        self.btn_gestione_lotti.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.btn_gestione_lotti, 0, 2, 1, 1)

        self.btn_valutazioni = QPushButton(self.gridLayoutWidget)
        self.btn_valutazioni.setObjectName(u"btn_valutazioni")
        self.btn_valutazioni.setEnabled(False)
        icon3 = QIcon(QIcon.fromTheme(u"document-print"))
        self.btn_valutazioni.setIcon(icon3)
        self.btn_valutazioni.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.btn_valutazioni, 2, 1, 1, 1)
        ...
        self.btn_impostazioni = QPushButton(self.gridLayoutWidget)
        self.btn_impostazioni.setObjectName(u"btn_impostazioni")
        sizePolicy.setHeightForWidth(self.btn_impostazioni.sizePolicy().hasHeightForWidth())
        self.btn_impostazioni.setSizePolicy(sizePolicy)
        icon4 = QIcon(QIcon.fromTheme(u"applications-utilities"))
        self.btn_impostazioni.setIcon(icon4)
        self.btn_impostazioni.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.btn_impostazioni, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_gestione_ditta.setText(QCoreApplication.translate("MainWindow", u"Gestione Ditta", None))
        self.btn_simulazione.setText(QCoreApplication.translate("MainWindow", u"Avvia Simulazione", None))
        self.btn_gestione_lotti.setText(QCoreApplication.translate("MainWindow", u"Gestione Lotti", None))
        self.btn_valutazioni.setText(QCoreApplication.translate("MainWindow", u"Valutazione Simulazione", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Aggiungere descrizione Gestione Lotti", None))
        self.btn_impostazioni.setText(QCoreApplication.translate("MainWindow", u"Impostazioni Simulazione", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Aggiungere descrizione attivit\u00e0 Impostazioni", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Aggiungere descrizione attivit\u00e0 gestione Ditta", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Aggiungere descrizione attivit\u00e0 Simulazione", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Aggiungere descrizione attivit\u00e0 Valutazione simulazione", None))
